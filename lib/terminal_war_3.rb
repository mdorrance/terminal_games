class Card
  def cards
    [{:card=>"2C",:value=>2}, {:card=>"3C",:value=>3}, {:card=>"4C",:value=>4}, {:card=>"5C",:value=>5}, {:card=>"6C",:value=>6}, {:card=>"7C",:value=>7}, {:card=>"8C",:value=>8}, {:card=>"9C",:value=>9}, {:card=>"10C",:value=>10}, {:card=>"JC",:value=>11}, {:card=>"QC",:value=>12}, {:card=>"KC",:value=>13}, {:card=>"AC",:value=>14},
...
class Game
  attr_accessor :Card
  def initialize
    @num_battles = 0 #initiates a ticker to keep track of the number of battles
  end
  ...
  def deal_cards
    deck_of_cards = []
    deck_of_cards = Card.new.cards.shuffle
